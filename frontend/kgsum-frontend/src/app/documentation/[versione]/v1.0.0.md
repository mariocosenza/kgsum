...
- Documentation and changelogs rendered from Markdown files in `frontend/kgsum-frontend/src/app/documentations`.
...
To document changes or new versions, add a Markdown file in `frontend/kgsum-frontend/src/app/documentations` following the version convention (e.g., `v1.1.0.md`).
