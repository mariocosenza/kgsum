                ...
                >
                  ...
                  <div className="min-h-[220px]">
                    ...
                    <TabsContent value="DUMP" className="space-y-4 mt-0">
                      <Card className="border-2 border-dashed border-muted hover:border-muted-foreground/50 transition-colors min-h-[180px]">
                        <CardContent className="p-6 space-y-4 flex flex-col justify-center min-h-[180px]">
                            ...
                            {selectedFile && (
                              <div className="mt-3 p-3 bg-muted/30 rounded-lg border">
                                <div className="flex items-center justify-between">
                                  ...
                                  <CheckIcon className="w-4 h-4 text-green-600 dark:text-green-400 ml-2 flex-shrink-0" />
                                </div>
                              </div>
                            )}
                          </div>
                      ...
                      {/* File size warning */}
                      {fileSizeWarning && (
                        <div className={`mt-4 p-3 rounded-lg border flex items-start space-x-2 ${
                    ...
                    <div className="flex-1">
                      ...
                      {selectedFile && (
                        <p className="text-green-600 dark:text-green-400 text-xs mt-1">
                          File elaborato: {selectedFile.name} ({formatFileSize(selectedFile.size)})
                        </p>
                      )}
                    </div>
                  </div>
