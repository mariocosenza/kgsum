                    ...
                    code: ({className, children, ...props}) => {
                        ...
                        if (!isInline && language) {
                            return (
                                <div className="my-6">
                                    <div
                                        className="flex items-center justify-between px-4 py-2 bg-slate-800 dark:bg-slate-900 rounded-t-lg">
                                        <Badge variant="secondary" className="text-xs font-mono">
                                            {language}
                                        </Badge>
                                    </div>
                                    <pre
                                        className="p-4 bg-slate-900 dark:bg-slate-800 text-slate-100 overflow-x-auto rounded-b-lg">
                        ...
                        return (
                            <code
                                className="relative rounded bg-muted/60 px-[0.3rem] py-[0.2rem] font-mono text-sm font-medium text-foreground" {...props}>
                                {children}
                            </code>
                        );
                    },
